...
from colophon.core.sequence_affix import (
    strip_encoding_artifact,
    strip_series_book_suffix,
    strip_series_code_affix,
)
...
def repair_fields(book: BookUnit) -> bool:
    ...
    if book.title and book.provenance.get("title") != Provenance.MANUAL.value:
        cleaned = strip_encoding_artifact(strip_series_book_suffix(strip_series_code_affix(book.title)))
